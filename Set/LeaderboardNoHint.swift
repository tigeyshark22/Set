...
class LeaderboardNoHint: UICollectionViewCell {
    
    var vspacing: CGFloat=0
    
    let titleLabel: UIStackView={
        let text1=TextView.init(text2: "").textView
        let text2=TextView.init(text2: "No Hints").textView
        text2.textColor = .red
    ...
    private func setUpCaption() {
        ...
        captionLabel.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor).isActive=true
    ...
    private func addLBRow(ind: Int) {
        let lb=Leaderboard(fileName: "setLBNoHints")
        var name=""
        var time=0
        ...
        textStack.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor).isActive=true
